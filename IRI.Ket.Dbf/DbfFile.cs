...
namespace IRI.Ket.ShapefileFormat.Dbf
{
    public static class DbfFile
    {
        ...
        internal static System.Data.DataTable Read(string dbfFileName, string tableName)
        {
        ...
        internal static object[][] ReadToObject(string dbfFileName, string tableName, Encoding dataEncoding, Encoding fieldHeaderEncoding, bool correctFarsiCharacters)
        {
            ChangeEncoding(dataEncoding);
        ...
        internal static object[][] ReadToObject(string dbfFileName, string tableName)
        {
            System.IO.Stream stream = new System.IO.FileStream(dbfFileName, System.IO.FileMode.Open);
        ...
        internal static void Write(string fileName, System.Data.DataTable table, Encoding encoding)
        {
